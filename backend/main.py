...
from fastapi import FastAPI, HTTPException, Depends, UploadFile, File, Query, BackgroundTasks, WebSocket, Form
...
app.add_middleware(RateLimitMiddleware, requests_per_minute=1000, burst_limit=100, block_duration=60)
